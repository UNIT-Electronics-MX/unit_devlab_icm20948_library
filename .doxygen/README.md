...
HTML documentation will be generated in `docs/html/`.
The full LaTeX build tree will be generated in `docs/latex/build/`.
...
- `../docs/latex/build/` - Complete LaTeX build tree
- `../docs/latex/refman.tex` - Main LaTeX manual entrypoint copied from the build tree
- `../docs/latex/refman.pdf` - Compiled PDF manual generated by CI
...
On `main`, CI commits the generated HTML, LaTeX build tree, `refman.tex`, and `refman.pdf`.
